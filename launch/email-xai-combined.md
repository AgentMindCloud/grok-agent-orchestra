...
just made Grok 4 multi-agent plug-and-play on X (Apache 2.0)

---

Hi xAI team,

Two community-built tools, released together, that turn Grok 4 into
...
build, Bridge calls grok-4-0709, scans the generated code, ships
...
`grok-4-0709` model or a visible
...
veto (`grok-4-0709` at high effort, strict JSON, fails closed)
...
- **Uses the official xai-sdk + grok-4-0709 verbatim.**
  No forked clients, no scraped endpoints, no parallel universes.
- **Makes Grok 4's multi-agent surface self-evident** — the
